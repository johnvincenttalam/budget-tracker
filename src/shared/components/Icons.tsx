...
export function TargetIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg {...defaults(size, { strokeWidth: 1.5, ...props })}>
      <path d="M12 2a10 10 0 1 0 10 10M12 6a6 6 0 1 0 6 6m-6-2a2 2 0 1 0 2 2m2-8h4m0 0v4m0-4l-6 6" />
    </svg>
  );
}
...
export function RingIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg {...defaults(size, { strokeWidth: 1.5, ...props })}>
      <path d="M12 3l2 4h-4l2-4zm-5 9a5 5 0 1 0 10 0 5 5 0 1 0-10 0z" />
    </svg>
  );
}
...
// Debt & Receivables icons
export function DebtIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg {...defaults(size, props)}>
      <path d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75" />
      <path d="M12 10.5V8.25m0 0L10.5 9.75M12 8.25l1.5 1.5" strokeWidth={2} />
    </svg>
  );
}

export function ReceivableIcon({ size = 20, ...props }: IconProps) {
  return (
    <svg {...defaults(size, props)}>
