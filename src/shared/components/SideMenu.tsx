...
import { ChartPieIcon, RepeatIcon } from './Icons';
...
export function SideMenu({
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed inset-y-0 left-0 w-64 bg-slate-900 z-[70] animate-slide-right shadow-2xl flex flex-col">
        {/* Header */}
        <div className="px-5 pt-6 pb-4 border-b border-slate-800">
          <h2 className="text-lg font-bold text-white">Budget Tracker</h2>
          <p className="text-xs text-slate-500 mt-0.5">Manage your finances</p>
        </div>
        ...
        <div className="px-5 py-4 border-t border-slate-800">
          <p className="text-[10px] text-slate-600">Budget Tracker v1.0</p>
        </div>
      </div>
    </>
  );
