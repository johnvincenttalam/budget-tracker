...
import { ChartPieIcon, RepeatIcon, DebtIcon, ReceivableIcon } from './Icons';
...
const menuItems: MenuItem[] = [
  ...
  },
  {
    screen: 'debts',
    label: 'Debts',
    icon: <DebtIcon size={20} />,
  },
  {
    screen: 'receivables',
    label: 'Receivables',
    icon: <ReceivableIcon size={20} />,
  },
  {
    screen: 'wallets',
    label: 'Wallets',
...
export function SideMenu({
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className="fixed inset-y-0 left-0 w-72 bg-slate-900 z-[70] animate-slide-right shadow-2xl flex flex-col">
        {/* Header */}
        <div className="px-6 pt-8 pb-5 border-b border-slate-800">
          <h2 className="text-lg font-bold text-white">Budget Tracker</h2>
          <p className="text-xs text-slate-500 mt-1">Manage your finances</p>
        </div>
        ...
        <div className="px-6 py-5 border-t border-slate-800">
          <p className="text-[10px] text-slate-600">Budget Tracker v2.0</p>
        </div>
      </div>
    </>
  );
