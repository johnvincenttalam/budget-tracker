  ...
  return (
    <div className="flex flex-col px-4 pt-4 pb-6">
      ...
      <input
        ...
        className="bg-slate-900 rounded-xl px-4 py-3 text-sm text-white placeholder:text-slate-500 outline-none focus:ring-2 focus:ring-emerald-500/40 transition-shadow mb-5"
      />
      ...
      <input
        ...
        className="bg-slate-900 rounded-xl px-4 py-3 text-sm text-white outline-none focus:ring-2 focus:ring-emerald-500/40 transition-shadow mb-5"
      />
      ...
      <input
        ...
        className="bg-slate-900 rounded-xl px-4 py-3 text-sm text-white placeholder:text-slate-500 outline-none focus:ring-2 focus:ring-emerald-500/40 transition-shadow mb-8"
      />
