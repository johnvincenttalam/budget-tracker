    ...
    return (
      <div className="flex items-center justify-center h-[80vh]">
        <div className="text-center">
          ...
          <p className="text-lg text-slate-300 animate-slide-up" style={{ animationDelay: '150ms', animationFillMode: 'backwards' }}>Expense updated!</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col h-[calc(100dvh-1rem)] px-4 pt-4 pb-2">
      ...
      <div className="sticky top-0 z-10 bg-slate-950 flex items-center justify-between pb-3 -mx-4 px-4 pt-0">
        ...
        <h2 className="text-base font-semibold text-white">Edit Expense</h2>
        <div className="w-14" />
      </div>
      ...
      <input
        ...
        className="bg-slate-900 rounded-xl px-4 py-2.5 text-sm text-white placeholder:text-slate-500 outline-none focus:ring-2 focus:ring-emerald-500/40 transition-shadow mb-2"
      />
      ...
      <input
        ...
        className="bg-slate-900 rounded-xl px-4 py-2.5 text-sm text-white outline-none focus:ring-2 focus:ring-emerald-500/40 transition-shadow mb-3"
      />
